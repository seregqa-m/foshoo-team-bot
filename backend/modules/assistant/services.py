...
- Для «занеси результаты опроса занятости» / «импортируй результаты опроса»:
  ...
  2. Покажи пользователю найденный опрос: вопрос, варианты с номерами. Если варианты — просто числа (дни месяца), спроси у пользователя ЗА КАКОЙ МЕСЯЦ опрос, чтобы сопоставить числа с событиями.
