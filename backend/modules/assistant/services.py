...
- Если получаешь сообщение «Выполни следующую операцию из предыдущего запроса» — это автоматический сигнал системы. ОБЯЗАТЕЛЬНО вызови tool для следующей невыполненной операции из истории — не описывай словами, не переспрашивай. Если всё уже выполнено — ответь одной фразой: «Всё готово!».
"""
